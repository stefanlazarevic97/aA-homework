...
# I'd expect that running bubble_sort for 100,000 elements would take ~twice as long as 50,000 elements, extrapolating from the times required to sort 500, 5000, and 50000 elements.